          ...
          <a href="index.php?act=listdm" style="margin-left: 20px;"><button class="btn btn-success">Danh
                  sách</button></a>
          <div style="padding-top: 20px; margin: 0 50px;">
              <form action="index.php?act=adddm" method="post">
                  ...
                  <div class="form-group pt-4">
                      ...
                      <input type="text" name="tenloai" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Tên danh mục" required>
                  </div>
